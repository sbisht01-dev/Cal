...
function parseLineFile2(line: string): { SrNo: any; Date: any; Party: any; AccNo: any; Prefix: any; BondNo: any; Denominations: any; BranchCode: any; PayTeller: any; } {
  ...
  function processFileForSecondFile(inputData: string) {
  ...
  function readInputFromFileForSecondFile(filePath: string) {
    fetch(filePath)
